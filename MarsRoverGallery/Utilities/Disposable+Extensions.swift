...
/// A DisposeBag is a handy way to store all of the disposables returned by each observation. When an observer de-initializes so does its dispose bag, which calls the dispose() function of every dispose-bag stored disposable.
class DisposeBag {
